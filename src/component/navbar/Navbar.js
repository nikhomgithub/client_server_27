...
export default function Navbar() {
    ...
    <div className="navFrame flex-center-center jc-space-between">
            ...
            <div className="d-none">
                ...
                <Link ref={refUser} to="/p27/user"/>
                <Link ref={refSetting} to="/p27/basicdata"/>
                <Link ref={refPartner} to="/p27/partner"/>
                <Link ref={refProduct} to="/p27/product"/>
                <Link ref={refTransaction} to="/p27/transaction"/>
                <Link ref={refTransactionLog} to="/p27/transactionlog"/>
