...
const submitFunctionEdit=(formInputState)=>{
    ...
    axios.post(`/p27basicdata/updatecustom`,temp,myheader)
        .then(result=>{
            setShowEdit(false)
            setReloadBasicData(true)
        })
...
const saveRouteAuthTableTemplateAxios=()=>{
    ...
    //console.log('temp')
    //console.log(temp)
    axios.post(`/p27tabletemplate/updatetabletemplate`,temp,myheader)
...
const submitFunctionEditRouteAuth=(formInputState)=>{
    ...
    axios.post(`/p27basicdata/updatecustom`,updateBasicData,myheader)
    .then(result=>{
    ...
    if(reloadRouteAuthTableTemplate){
        ...
        if(localStorage.getItem('shopauthorization')&&
           ...
           //to ensure user&shop token in place before request to server
            ...
            axios.post('/p27tabletemplate/getcustom',
            {},myheader
            /*
