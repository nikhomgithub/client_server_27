...
function UserWelcome() {
  ...
  const submitAddUser=(formInputState)=>{
    axios.post(`/p27user/adduser`,formInputState,myheader)
    .then(result=>{
  ...
  const submitChangePassword=(formInputState)=>{
    axios.post(`/p27user/changepassword`,formInputState,myheader)
    .then(result=>{
  ...
  const submitLogIn=(formInputState)=>{
    axios.post(`/p27user/login`,formInputState,myheader)
    .then(result=>{
